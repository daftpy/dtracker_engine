...
{
    auto unit = std::make_unique<MockPatternPlaybackUnit>();
    unit->leftValue = 1.0f;
...
{
    // Test full left pan
    auto mockLeft = std::make_unique<MockPatternPlaybackUnit>();
    ...
    // Test full right pan
    auto mockRight = std::make_unique<MockPatternPlaybackUnit>();
...
TEST_F(PatternPlaybackTest, TriggersNotesFromPool)
{
    ...
    pool.queueUnit(std::make_shared<playback::SamplePlaybackUnit>());
    pool.queueUnit(std::make_shared<playback::SamplePlaybackUnit>());
...
TEST(TrackPlaybackUnit, PlaysPatternsSequentially)
{
    ...
    auto pattern3 = std::make_unique<MockPatternPlaybackUnit>();
    ...
    track.addUnit(std::move(pattern3));
